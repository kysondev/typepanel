...
import { addTextToKnowledgeBaseHandler } from "features/core/knowledge/knowledge.controller";
...
export function AddTextContentModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    const res = await addTextToKnowledgeBaseHandler(kbId, title, content);
    setIsLoading(false);
